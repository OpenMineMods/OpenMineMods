...
class Ui_ModWidget(object):
    def setupUi(self, ModWidget):
        ...
        self.mod_update = QtWidgets.QToolButton(ModWidget)
        icon = QtGui.QIcon.fromTheme("software-update-available-symbolic")
        self.mod_update.setIcon(icon)
        self.mod_update.setObjectName("mod_update")
        self.horizontalLayout.addWidget(self.mod_update)
    ...
    def retranslateUi(self, ModWidget):
        ...
        self.mod_update.setText(_translate("ModWidget", "..."))
